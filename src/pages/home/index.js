      ...
      <View style={styles.cardsContainer}>
        ...
        <View style={styles.resultsContainer}>
          ...
          <ScrollView showsVerticalScrollIndicator={true}>
            ...
            <Text style={styles.resultsText}>Forasteiros 2 x 2 Águias</Text>
        ...
        {/* Ícones reposicionados na parte inferior */}
        <View style={styles.iconsRowBottom}>
          ...
          <CardService iconName="tennisball-outline" iconSize={60} iconColor={customBlack} serviceName="Vôlei" />
